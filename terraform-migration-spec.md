...
| 구분 | 리소스 | 식별자 / 값 | 출처 |
|---|---|---|---|
| 컴퓨팅 | EC2-A (상시 가동) | `ec2-15-165-102-5.ap-northeast-2.compute.amazonaws.com`, 포트 8080, 인스턴스 ID 미확인 | `register-ssm-params.sh` |
...
2. EC2-A 인스턴스 ID·SG·인스턴스 프로파일: `aws ec2 describe-instances --filters "Name=dns-name,Values=ec2-15-165-102-5..."`
