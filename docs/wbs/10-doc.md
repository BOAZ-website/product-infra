...
**목적:** 구 WBS(`docs/wbs.md`)를 담았던 PR #12를 새 WBS·명세서·문서 구조 개편 PR로 바꿨으므로, 리뷰를 거쳐 머지하고 이슈 #11을 닫는다. 기존 "wbs.md 상태 오기 정정" 작업은 구 문서 삭제로 불필요해졌다.
...
**목적:** 검토 보고서에서 찾은 스펙 결함 9건을 착수 전에 고친다.
