...
> 진행: STA-01-01은 PR #9에 완료(리뷰 대기). STA-01-03(그룹별 파일)은 PR #9 머지 후 추가.
...
| 기능 ID | 기능 | 완료 확인 방법 |
| --- | --- | --- |
| STA-07-01 | plan 결과(JSON)에서 보호 자원(RDS·EC2·CloudFront·Route53 레코드·S3)의 삭제·교체가 나오면 차단 | 일부러 교체를 일으키는 변경에서 검사 실패 |
...
| 규모 | 선행 | 차단 결정 | 마일스톤 | tasks.md | GitHub 이슈 |
| --- | --- | --- | --- | --- | --- |
| 하루이틀 | CMP-01, RDB-01, CDN-01, DEP-01 | 없음 | MS2b | 5.2 | 없음 |
