...
| --- | --- | --- | --- | --- | --- |
| 한 주 | STA-07, Phase 2 1차 | 없음 | Phase 2 2차 | 5.1 | 없음 |
...
| 규모 | 선행 | 차단 결정 | Phase | tasks.md | GitHub 이슈 |
| --- | --- | --- | --- | --- | --- |
| 한 주 | CMP-02, CDN-02, STA-09, STA-11 | 없음 | Phase 4 | 7.1, 8.7 | 없음 |
...
| 규모 | 선행 | 차단 결정 | Phase | tasks.md | GitHub 이슈 |
| --- | --- | --- | --- | --- | --- |
| 한 주 | SEA-02 | 없음 | Phase 4 | 7.2, 8.8 | 없음 |
