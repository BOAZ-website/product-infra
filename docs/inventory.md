...
| SSH SG | `sg-05b499bad8d9637d1` | `prod-ssh-sg`, ingress TCP 22 ← `58.29.180.104/32`, `106.101.8.217/32` | managed |
...
| 자원 | 식별자 | 현재 설정 | ownership |
|---|---|---|---|
| EC2-A | `i-08bb34407c19504cf` | `boaz-api-prod-A`, running, t3.small, 2a, subnet `...224a25`, private 10.0.1.44, public 15.165.102.5, AMI `ami-0fc2b553b2bbfaee0`, 태그 `app=boaz-api` 있음 | managed |
